...
userRouter.post("/registerUser", registerUserRules(), validation, async (req, res) => {
  const { name, lastname, email, password, phone,adress, isAdmin,userType } = req.body;
  try {
    const newUser = new User({ name, lastname, email, password, phone,adress, isAdmin,userType });
